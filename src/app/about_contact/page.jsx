    ...
    <>
      ...
      <section className={styles["about-main"]}>
        ...
        <section className={styles["contact-section"]}>
          ...
          <p className={styles["bio-copy"]}>
            Based in Denver, Colorado<br /><br />
            (303) 807-8479<br /><br />
            dbuddphoto@me.com<br /><br />
            Call or email me today to discuss your next project!<br /><br />
          </p>
        </section>
      </section>
    </>
