...
export default function Gallery({ galleryProps }) {
  const gallerySwiperDivRef = useRef(null);
  ...
  return (
    <>
      ...
      <BackgroundImg vertImg={galleryProps.vertBackgroundImg} horizImg={galleryProps.horizBackgroundImg} />
      <section className={styles.gallery}>
        <div className={styles['gallery-spacer']}></div>
        <div className={styles['gallery-swiper']} ref={gallerySwiperDivRef}>
          <GallerySwiper
            gallerySwiperDivRef={gallerySwiperDivRef}
            images={{
